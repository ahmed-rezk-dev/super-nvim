...
vim.cmd "nnoremap <silent> <C-S-k> <cmd>lua vim.lsp.buf.signature_help()<CR>"
vim.cmd "nnoremap <silent> <C-S-p> :Lspsaga diagnostic_jump_prev<CR>"
vim.cmd "nnoremap <silent> <C-S-n> :Lspsaga diagnostic_jump_next<CR>"
