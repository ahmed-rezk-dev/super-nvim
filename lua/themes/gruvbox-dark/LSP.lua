local LSP = {
  ...
  NvimTreeNormal = { fg = C.light_gray, bg = Config.transparent_background and "NONE" or C.alt_bg },
  ...
  -- Bufferline
  BufferCurrent = { fg = C.fg, bg = C.green },
  BufferCurrentIndex = { fg = C.fg, bg = C.green },
  BufferCurrentMod = { fg = C.info_yellow, bg = C.green },
  BufferCurrentSign = { fg = C.hint_blue, bg = C.green },
  BufferCurrentTarget = { fg = C.red, bg = C.green, style = "bold" },
  BufferVisible = { fg = C.fg, bg = C.green },
  BufferVisibleIndex = { fg = C.fg, bg = C.green },
  BufferVisibleMod = { fg = C.info_yellow, bg = C.green },
  BufferVisibleSign = { fg = C.hint_blue, bg = C.green },
  BufferVisibleTarget = { fg = C.red, bg = C.green, style = "bold" },
  ...
  -- BufferTabpageFill = { fg = C.red, bg = C.orange }, -- Tobbar pag background under the tabs.
  -- BufferTabpages = { fg = C.red, bg = C.orange }, -- Tobbar pag background under the tabs.
