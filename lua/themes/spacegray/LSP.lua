local LSP = {
  ...
  IndentBlanklineContextChar = { fg = C.light_green },
  ...
  diffFileId = { fg = C.light_green, style = "bold,reverse" },
  diffFile = { fg = C.alt_bg },
  diffNewFile = { fg = C.light_green },
