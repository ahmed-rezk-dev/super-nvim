local highlights = {
  ...
  SpellLocal = { fg = C.light_green, style = "underline" },
  SpellRare = { fg = C.purple, style = "underline" },
  NormalNC = { fg = C.fg, bg = C.bg },
  Pmenu = { fg = C.white, bg = C.accent },
  PmenuSel = { fg = C.alt_bg, bg = C.light_green },
  WildMenu = { fg = C.alt_bg, bg = C.light_green },
  ...
  SpecialKey = { fg = C.light_green, style = "bold" },
  Title = { fg = C.light_green, style = "bold" },
  ...
  Typedef = { fg = C.purple },
  Keyword = { fg = C.light_green },
  Statement = { fg = C.light_green },
  Conditional = { fg = C.light_green },
  Repeat = { fg = C.light_green },
  Label = { fg = C.light_green },
  Exception = { fg = C.light_green },
  Include = { fg = C.light_green },
  PreProc = { fg = C.cyan },
  Define = { fg = C.cyan },
  Macro = { fg = C.cyan },
  PreCondit = { fg = C.cyan },
